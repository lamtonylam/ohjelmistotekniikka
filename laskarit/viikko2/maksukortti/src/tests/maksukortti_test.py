...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_maukkaan_syominen_ei_vie_saldo_negatiiviseksi(self):
        kortti = Maksukortti(200)
        kortti.syo_maukkaasti()

    def test_negatiivisen_lataaminen_ei_vie_saldoa_negatiiviseksi(self):
        self.kortti.lataa_rahaa(-100)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def edullinen_lounas_kun_tasaraha(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

    def maukas_lounas_kun_tasaraha(self):
